...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/kongbar/movetone/main/000-default.conf?token=GHSAT0AAAAAABTAY4CASUF7JDXTQJDO66JOYSFTIGQ
...
RUN echo root:123567890|chpasswd
